...
if (isset($_POST["action"])) {
    ...
    //converting to date
    $datum_gebruik = mysqli_real_escape_string($link, $_POST["datum_uitgave"]);
    $datum_gebruik = date('Y-m-d', strtotime(str_replace('-', '/', $datum_gebruik)));
    //converting to date 
...
";
    ...
    if (!$stmt) {
        ...
        if (!mysqli_stmt_prepare($stmt, $query)) {
            ...
            mysqli_stmt_bind_param($stmt, 'ssssssss', $naam, $afdeling, $datum_gebruik, $datum_terug, $gewenste_apparaat, $bijzonderheden, $getest_door, $datum_test);
            //execute statement
